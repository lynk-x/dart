...
class ForumCache {
  ...
  static Future<List<ChatMessage>> getCachedMessages(
    ...
    return maps.map((map) {
      ...
      // We need to pass the current user ID to fromMap to set isMe correctly.
      // However, we don't have it here. We'll set it as an empty string and
      // let the Cubit handle it if needed.
